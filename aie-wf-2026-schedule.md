# AI Engineer World's Fair 2026 — My Personalized Schedule

**Ticket:** Engineering + Workshops (no Leadership-track rooms)
**Dates:** June 29 – July 2, 2026 · Moscone West, San Francisco · (America/Los_Angeles)
**Profile:** Advanced AI/software engineer · focus on *harness internals + evals*, then coding agents & retrieval · stack = Claude / OpenAI / open-source · **tie-breaker: hands-on / apply-it-Monday** · networking time protected.

**Legend:** ⭐ anchor/marquee · 🟢 protected networking · 🎤 Main Stage keynote · *alt* = backup pick if you want to pivot live · Tr = Track room.

---

## 📅 Day 1 — Mon Jun 29 · Workshop Day
*Strategy: one long anchor deep-dive + sharp 1-hour hands-on hits.*
...
## 📅 Day 3 — Wed Jul 1 · Context Engineering + Memory ⭐ *(your best day)*

| Time | ✅ Pick | Track | Backup (alt) |
|---|---|---|---|
| 9:00–10:30 | 🎤 **Keynotes** — 2026 AI Eng Survey · "Verifiers are King" · Perception Agents · Evals Intro (Laurie Voss) | Main | — |
...
> 💡 **Hands-on anchor option:** **John Lindquist "Agentic Power User's Playbook: Swarm-Style Agentic Development"** (Track 4, 1:30–2:45).

---

## 📅 Day 4 — Thu Jul 2 · Agentic + Harness Engineering ⭐ *(your other best day)*
...
| 3:45–4:05 | **Agents Without Code: Skills, YAML & Filesystems Replaced Python** — Philipp Schmid | Harness Engineering | Open Source Is Dead. Long Live Open Source — Saoud Rizwan |
| 4:30–5:30 | 🎤 **Closing keynotes** — Theo Browne · Garry Tan · Startup Battlefield (Howie Liu) | Main | — |

---

### Notes
- All picks are access-checked against the **Engineering + Workshops** ticket (no *Leadership 1/2/Lounge* rooms — i.e. no AI-Native Enterprises, CTO Circle, or AI Architects sub-tracks).
- Breakout talks are 20 min — room-hopping is expected; the *alt* column is your live pivot list.
- Rooms/times for some sessions were marked tentative in the source data; confirm on the official app the morning of.
